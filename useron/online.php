...
$main_site = "www.of.in.th";	// ใส่ URL ของเว็บไซต์คุณครับ (ไม่ต้องมี http:// นะ)
$surl = "online.php";		// Url to the script.

$b_link = "FASLE";		// ตรงข้อความบอกจำนวนผู้ Online จะให้เป็น Link ไปยังหน้าบอกข้อมูลการ Online ไหม (ต้องการ ใส่ TRUE หรือ ไม่ต้องการ ใส่ FASLE ลงไป)
